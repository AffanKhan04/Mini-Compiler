...
A complete compiler implementation for **Mini Compiler**, a domain-specific mini language designed for numerical computations and pattern generation. This project demonstrates all six major phases of compiler construction.

## 🎯 Project Overview

Mini Compiler is a statically-typed mini language that supports:
