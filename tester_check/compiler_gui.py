"""
Mini Compiler - Graphical User Interface
A simple GUI for the Mini compiler with editor, output, and IR viewer
"""
...
class CompilerGUI:
    ...
    def create_toolbar(self, parent):
        ...
        # Title
        title = ttk.Label(toolbar, text="Mini Compiler", font=("Arial", 16, "bold"))
    ...
    def open_file(self):
        ...
        filename = filedialog.askopenfilename(
            title="Open File",
            filetypes=[("Mini Files", "*.nc"), ("All Files", "*.*")]
        )
        if filename:
            try:
